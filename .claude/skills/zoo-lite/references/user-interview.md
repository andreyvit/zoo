...
1. Gather pending questions from:
   - spec file `Open product and strategic questions`
   - reports written since the last `user-interview` report
...
4. Use `zoo-plan` to apply answers to `User Input`, `Spec`, `Decision log`, `Open product and strategic questions`, and `Subtasks` as needed.
